...
<section class="content-outer">
    <div class="content-inner">
        ...
        <div class="why-rows">
            ...
            <div class="ci-features-box">
                <div class="ci-features-box-icon">
                  <svg xmlns="http://www.w3.org/2000/svg" width="51" height="59" viewBox="0 0 51 59" xml:space="preserve"><path fill="" d="M26.303 13.447a.668.668 0 0 1-1.336 0v-2.272a.669.669 0 0 1 1.336 0v2.272zM10.1 29.573c.368 0 .667.298.667.666a.67.67 0 0 1-.667.669H7.827a.667.667 0 1 1 0-1.335H10.1zM40.901 30.239a.666.666 0 1 1 0-1.333h2.271a.668.668 0 1 1 0 1.333h-2.271zM37.839 19.838a.665.665 0 0 1-.942-.019.664.664 0 0 1 .02-.945l1.639-1.573a.665.665 0 0 1 .942.019.665.665 0 0 1-.018.943l-1.641 1.575zM14.525 18.075a.667.667 0 1 1-.963.924l-1.574-1.64a.667.667 0 1 1 .965-.924l1.572 1.64zM29.062 29.275c-.776.467-1.574.567-1.78.222-.209-.344.252-1.003 1.028-1.471l4.783-2.884c.776-.468 1.575-.567 1.783-.223.21.346-.252 1.004-1.028 1.472l-4.786 2.884z"/><circle fill="" cx="25.75" cy="30.24" r="3.031"/><path fill="" d="M34.102 40.217a.887.887 0 0 1-.888.888H18a.89.89 0 1 1 0-1.777h15.214c.491 0 .888.398.888.889z"/><circle fill="none" stroke="" stroke-miterlimit="10" cx="25.501" cy="29.427" r="22.833"/><circle fill="none" stroke="" stroke-miterlimit="10" cx="25.501" cy="29.426" r="18.341"/></svg>
                </div><!--ci-features-box-icon ends here-->
                <div class="ci-features-box-text-area">
        ...
        <div class="why-rows">
            ...
            <div class="ci-features-box">
                <div class="ci-features-box-icon">
                  <svg xmlns="http://www.w3.org/2000/svg" width="51" height="59" viewBox="0 0 51 59" xml:space="preserve"><path fill="none" stroke="" stroke-miterlimit="10" d="M49.691 13.907c0-3.191-4.055-4.724-4.055-4.724-8.234-.479-13.945-4.085-16.66-6.447C26.266.375 25.5.981 25.5.981s-.767-.606-3.479 1.755c-2.713 2.362-8.425 5.969-16.66 6.447 0 0-4.054 1.532-4.054 4.724s-3.256 26.906 11.426 37.757c0 0 6.171 5.021 12.767 6.425 6.596-1.403 12.768-6.425 12.768-6.425 14.679-10.851 11.423-34.565 11.423-37.757z"/><path fill="" d="M32.074 24.864c-.637-.625-1.912-.313-3.104.855l-5.778 5.888-1.943-1.907c-.615-.603-1.622-.576-2.247.061s-.634 1.643-.018 2.249l3.401 3.336c.615.604 1.621.576 2.246-.063.282-.286 6.648-7.298 6.648-7.298 1.192-1.343 1.433-2.496.795-3.121z"/></svg>
                </div><!--ci-features-box-icon ends here-->
                <div class="ci-features-box-text-area">
        ...
        <div class="why-rows">
            <div class="ci-features-box">
                <div class="ci-features-box-icon">
                  <svg xmlns="http://www.w3.org/2000/svg" width="51" height="59" viewBox="0 0 51 59" xml:space="preserve"><path fill="none" stroke="" stroke-linecap="round" stroke-linejoin="round" stroke-miterlimit="10" d="M25.5 15.164S4.592 11.821.673 13.781v31.89s12.874-7.103 24.827-1.914c11.952-5.188 24.827 1.914 24.827 1.914v-31.89c-3.92-1.96-24.827 1.383-24.827 1.383z"/><path fill="" stroke="" stroke-linecap="round" stroke-linejoin="round" stroke-miterlimit="10" d="M25.563 15.202s-9.377-6.457-20.446-3.843v28.132s12.299-1.538 20.446 3.536c8.147-5.074 20.446-3.536 20.446-3.536V11.359c-11.067-2.614-20.446 3.843-20.446 3.843z"/><path fill="" d="M25.5 14.5s-1.143 19.565.513 28.527"/></svg>
                </div><!--ci-features-box-icon ends here-->
                <div class="ci-features-box-text-area">
...
<section id="important-links-outer">
    <div id="important-links-inner">
        ...
        <a href="https://forum.codeigniter.com/" class="important-link" target="_blank">
            <div class="important-link-boxes">
                <span class="boldy600 dark">Get Support & Discuss</span>
                <br />
                View The Forums
                <br /><br />

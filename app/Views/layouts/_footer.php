<footer id="footer-outer">
    <div id="footer-inner">
        ...
        <div id="footer-inner-right">
            <a href="https://github.com/codeigniter4/CodeIgniter4" target="_blank" aria-label="GitHub">
